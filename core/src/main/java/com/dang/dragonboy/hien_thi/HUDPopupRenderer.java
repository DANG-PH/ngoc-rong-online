...
public class HUDPopupRenderer {
    ...
    public void renderPopup(SpriteBatch batch) {
        ...
        for (int i = 0; i < 5; i++) {
            Texture nutcn = veHUD.trangThaiChucNangHUD.ordinal() == i ? veHUD.nutchucnangclick : veHUD.nutchucnang;
        ...
        if (veHUD.trangThaiChucNangHUD == TrangThaiChucNangHUD.NHIEM_VU){
        ...
        if (veHUD.trangThaiChucNangHUD == TrangThaiChucNangHUD.HANH_TRANG){
            // chỉ số nhân vật
            if (veHUD.dangHopThe) {
        ...
        if (veHUD.trangThaiChucNangHUD == TrangThaiChucNangHUD.KY_NANG){
            DecimalFormat dinhDang = new DecimalFormat("#,###");
        ...
        if (veHUD.trangThaiChucNangHUD == TrangThaiChucNangHUD.BANG_HOI){
            layout.setText(veHUD.fontNhiemVu,"Bang hội đang phát triển!");
            veHUD.fontNhiemVu.draw(batch,layout,0+(350- layout.width)/2f,420);
        }
        if (veHUD.trangThaiChucNangHUD == TrangThaiChucNangHUD.CHUC_NANG) {
            if (veHUD.trangThaiChucNangHUDChucNang == TrangThaiChucNangHUD_ChucNang.NONE || veHUD.trangThaiChucNangHUDChucNang == TrangThaiChucNangHUD_ChucNang.MINIGAME) {
                String[] chucNang;
            ...
            if (veHUD.trangThaiChucNangHUDChucNangMiniGame == TrangThaiChucNangHUD_ChucNang_MiniGame.HUONG_DAN_THEM_CSMM) {
                layout.setText(
            ...
            if (veHUD.trangThaiChucNangHUDChucNang == TrangThaiChucNangHUD_ChucNang.THONG_BAO && veHUD.trangThaiChucNangHUDChucNangThongBao == TrangThaiChucNangHUD_ChucNang_ThongBao.LIEN_HE_ADMIN) {
                float viewY = 35;
                float viewHeight = 444 - 35;
                batch.flush();
                Gdx.gl.glEnable(GL20.GL_SCISSOR_TEST);
                ...
                layout.setText(
                    ...
                    "Liên hệ Admin:\n" +
                        ...
                        "Trang chủ dự án: ngocrongdark.com\n" +
            ...
            if (veHUD.trangThaiChucNangHUDChucNang == TrangThaiChucNangHUD_ChucNang.THONG_BAO && veHUD.trangThaiChucNangHUDChucNangThongBao == TrangThaiChucNangHUD_ChucNang_ThongBao.THONG_BAO_CAP_NHAT) {
                float viewY = 35;
                float viewHeight = 444 - 35;
                batch.flush();
                Gdx.gl.glEnable(GL20.GL_SCISSOR_TEST);
            ...
            if (veHUD.trangThaiChucNangHUDChucNang == TrangThaiChucNangHUD_ChucNang.THONG_BAO && veHUD.trangThaiChucNangHUDChucNangThongBao == TrangThaiChucNangHUD_ChucNang_ThongBao.THONG_BAO_X2X3) {
                float viewY = 35;
                float viewHeight = 444 - 35;
                batch.flush();
                Gdx.gl.glEnable(GL20.GL_SCISSOR_TEST);
            ...
            if (veHUD.trangThaiChucNangHUDChucNang == TrangThaiChucNangHUD_ChucNang.THONG_BAO && veHUD.trangThaiChucNangHUDChucNangThongBao == TrangThaiChucNangHUD_ChucNang_ThongBao.GIFTCODE_TAN_THU) {
                float viewY = 35;
                float viewHeight = 444 - 35;
                batch.flush();
                Gdx.gl.glEnable(GL20.GL_SCISSOR_TEST);
            ...
            if (veHUD.trangThaiChucNangHUDChucNang == TrangThaiChucNangHUD_ChucNang.THONG_BAO && veHUD.trangThaiChucNangHUDChucNangThongBao == TrangThaiChucNangHUD_ChucNang_ThongBao.EVENT_SAP_TOI) {
                float viewY = 35;
                float viewHeight = 444 - 35;
                batch.flush();
                Gdx.gl.glEnable(GL20.GL_SCISSOR_TEST);

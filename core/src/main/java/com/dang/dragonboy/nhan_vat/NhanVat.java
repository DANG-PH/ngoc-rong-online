...
public class NhanVat {
    ...
    public void fixCaiTrang(NhanVatCauHinh c){

        this.avt = c.avt;

        this.dau_dung = c.dau_dung;
        this.dau_chay = c.dau_chay;
        this.than_dung = c.than_dung;
        this.than_nhay = c.than_nhay;
        this.than_roi = c.than_roi;
        this.than_chay = c.than_chay;

        this.chan_dung = c.chan_dung;
        this.chan_nhay = c.chan_nhay;
        this.chan_roi = c.chan_roi;
        this.chan_chay = c.chan_chay;

        this.than_bay = c.than_bay;
        this.chan_bay = c.chan_bay;

        this.chan_gong = c.chan_gong;
        this.than_thu = c.than_thu;

        this.rong = than_dung.getWidth() * tiLe;
        this.rong_chan = chan_dung.getWidth() * tiLe;
        this.cao = chan_dung.getHeight() * tiLe + than_dung.getHeight() * tiLe + dau_dung.getHeight() * 0.15f;
        this.lechTheoTrangThai = c.lechMap;

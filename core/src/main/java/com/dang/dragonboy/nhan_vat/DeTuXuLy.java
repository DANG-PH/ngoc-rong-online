...
public class DeTuXuLy {
    ...
    public static DeTuCauHinh loadAvatarSet(String hanhtinh ,String avatar, String ao, String quan) {
    ...
    public static DeTuCauHinh xuly_id(String id) {
